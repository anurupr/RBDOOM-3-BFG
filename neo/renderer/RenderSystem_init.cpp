...
idCVar vr_playerHeightCM( "vr_playerHeightCM", "177", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_FLOAT, "player height for vr in centimeters" );
...
idCVar vr_knockbackScale( "vr_knockbackScale", "0.1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_FLOAT, "how much knockback affects you" );
